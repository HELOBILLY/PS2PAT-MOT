...
class EMMFeatureExtractor(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        resolution = cfg.MODEL.TRACK_HEAD.POOLER_RESOLUTION  ##15
        scales = cfg.MODEL.TRACK_HEAD.POOLER_SCALES ##(0.25, 0.125, 0.0625, 0.03125)
        sampling_ratio = cfg.MODEL.TRACK_HEAD.POOLER_SAMPLING_RATIO  ##2
        r = cfg.MODEL.TRACK_HEAD.SEARCH_REGION  ##2.0
