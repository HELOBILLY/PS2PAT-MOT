...
dataset_maps['DETRAC'] = ['DETRAC',
                          'anno.json',
                          'splits.json',
                          'video']

dataset_maps['VISO'] = ['VISO',
                          'anno.json',
                          'splits.json',
                          'video']

dataset_maps['SateMOT'] = ['SateMOT',
                          'anno.json',
                          'splits.json',
                          'video']
...
dataset_maps['DOTA'] = ['DOTA',
                            'annotations/dota_train.json',
                            'Images',
                            'image']

dataset_maps['DOTA_AUG'] = ['DOTA',
                            'annotations/dota_aug_train.json',
                            'Images',
                            'image']
