...
def load_coco_anno(dataset_folder,
    ...
    print('dataset_anno_path', dataset_anno_path)
    dataset = COCO(dataset_anno_path)
    return dataset


def load_dataset_anno(cfg, dataset_key, set=None):
    # # all raw images would be in dataset_root/mscoco/images/train2017
    # 'mscoco', 'annotations/MSCOCO2017_train_person.json', 'images/train2017', 'image' 
    # dataset_maps['MOT17_DPM'] = ['MOT17','anno.json', 'splits_DPM.json', 'video'] 
