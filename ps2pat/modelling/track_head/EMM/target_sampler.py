...
class EMMTargetSampler(object):
    ...
    def match_targets_with_iou(self, proposal: BoxList, gt: BoxList):
        # print('proposal', proposal.__len__, 'gt', gt.__len__)
    ...
    def generate_pos_hn_example(self, proposals, gts):
        ...
        """
        # print('proposals', proposals[0].__len__, proposals[1].__len__)
        # print('gts', gts[0].__len__, gts[1].__len__)
        # print('*************************')
    ...
    def __call__(self, proposals: [BoxList], gts: [BoxList]):
        ...
        # print(pos_hn_src[0].__len__, pos_hn_src[1].__len__, pos_hn_pair[0].__len__, 
        #       pos_hn_pair[1].__len__, pos_hn_tar[0].__len__, pos_hn_tar[1].__len__)
        neg_src, neg_pair, neg_tar = self.generate_neg_examples(proposals, gts, pos_hn_src)
        # print(neg_src[0].__len__, neg_src[1].__len__, neg_pair[0].__len__, 
        #       neg_pair[1].__len__, neg_tar[0].__len__, neg_tar[1].__len__)
